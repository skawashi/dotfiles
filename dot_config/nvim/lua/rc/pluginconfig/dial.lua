...
vim.keymap.set("n", "-", require("dial.map").dec_normal(), { silent = true, noremap = true })
vim.keymap.set("v", "+", require("dial.map").inc_visual(), { silent = true, noremap = true })
vim.keymap.set("v", "-", require("dial.map").dec_visual(), { silent = true, noremap = true })
vim.keymap.set("v", "g+", require("dial.map").inc_gvisual(), { silent = true, noremap = true })
vim.keymap.set("v", "g-", require("dial.map").dec_gvisual(), { silent = true, noremap = true })
